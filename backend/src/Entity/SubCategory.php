...
class SubCategory
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Expenses::class, mappedBy: 'subCategoryId')]
    ...
    public function removeExpense(Expenses $expense): static
    {
        if ($this->expenses->removeElement($expense)) {
            ...
            if ($expense->getSubCategoryId() === $this) {
                $expense->setSubCategoryId(null);
            }
        }
