...
class BudgetMonthController extends AbstractController
{
    ...
    public function index(BudgetMonthRepository $budgetMonthRepository): Response
    {
        return $this->render('budget_month/index.html.twig', [
            'budget_months' => $budgetMonthRepository->findAll(),
        ]);
    }
